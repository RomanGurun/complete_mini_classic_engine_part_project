...
# Setup base and model directories
...
# Import the regression model and scaler
from model.Regression import MultiLinearRegression, DataScaler


def get_available_companies():
    """Fetch available company names from saved model files."""
...
def home(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            vol_val = request.POST.get("vol")  # ✅ Fixed case: 'vol' not 'Vol'
            ...
            # Prepare paths to model and scaler
